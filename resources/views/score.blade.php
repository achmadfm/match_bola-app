        ...
        <div class="col-md-12">
            <form action="" method="post">
                ...
                <div class="form-group">
                    ...
                    <input type="number" value="0" class="form-control" id="score_club_1" name="score_club_1"
                        placeholder="Score Klub 1" required>
                </div>
                <hr>
                <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <input type="number" value="0" class="form-control" id="score_club_2" name="score_club_2"
                        placeholder="Score Klub 1" required>
                </div>
